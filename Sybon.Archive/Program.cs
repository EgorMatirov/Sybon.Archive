...
namespace Sybon.Archive
{
    public static class Program
    {
        ...
        private const string ServiceDisplayName = "Sybon.Archive web api";
        private const string ServiceDescription = "Sybon.Archive web api";
    ...
    internal class MyService : IWin32Service
    {
        ...
        public string ServiceName => "Sybon.Archive";
